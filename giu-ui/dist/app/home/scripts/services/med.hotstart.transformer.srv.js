System.register('app/home/scripts/services/med.hotstart.transformer.srv', ['./med.time.base.transformer.srv.js'], function (_export) {
  'use strict';

  var TimeBaseTransformer, HotStartTransformerService;
  return {
    setters: [function (_medTimeBaseTransformerSrvJs) {
      TimeBaseTransformer = _medTimeBaseTransformerSrvJs['default'];
    }],
    execute: function () {
      HotStartTransformerService = (function () {
        function HotStartTransformerService() {
          babelHelpers.classCallCheck(this, HotStartTransformerService);
        }

        babelHelpers.createClass(HotStartTransformerService, [{
          key: 'hotStartToString',
          //extends TimeBaseTransformer {

          value: function hotStartToString(hotStart) {
          ...
          key: 'hotStartToObject',
          value: function hotStartToObject(hotStart) {
        ...
        return HotStartTransformerService;
      })();

      _export('default', HotStartTransformerService);
    }
  };
});
//# sourceMappingURL=med.hotstart.transformer.srv.js.map
